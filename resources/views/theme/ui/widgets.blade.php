    ...
    <div class="row">
        <div class="col-md-12">
            <ul class="nav nav-boxed nav-justified">
                <li><a href="javascript:;"><i class="color-success fa fa-home"></i> Home</a></li>
                <li><a href="javascript:;"><i class="color-warning fa fa-music"></i> Music</a></li>
                <li><a href="javascript:;"><i class="color-danger fa fa-film"></i> Film</a></li>
                <li><a href="javascript:;"><i class="color-info fa fa-bookmark"></i> Bookmark</a></li>
                <li><a href="javascript:;"><i class="color-primary fa fa-camera"></i> Photo</a></li>
                <li><a href="javascript:;"><i class="color-info-alt fa fa-map-marker"></i> Map</a></li>
                <li><a href="javascript:;"><i class="color-gray fa fa-phone-square"></i> Phone</a></li>
            </ul>
        </div>
    </div>
            ...
            <section class="panel panel-box">
                ...
                <div class="panel-bottom bg-reverse">
                    <ul class="list-justified text-center">
                        <li>
                            <p class="size-h2 color-info"><i class="wi wi-cloudy"></i></p>
                            <p class="text-muted">Tuesday</p>
                        </li>
                        <li>
                            <p class="size-h2 color-warning"><i class="wi wi-day-thunderstorm"></i></p>
                            <p class="text-muted">Wednesday</p>
                        </li>
                        <li>
                            <p class="size-h2 color-danger"><i class="wi wi-day-snow"></i></p>
                            <p class="text-muted">Thursday</p>
                        </li>
                        <li>
                            <p class="size-h2 color-success"><i class="wi wi-day-sunny"></i></p>
